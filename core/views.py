...
class AccessoryView(ListView):
    model = Item
    paginate_by = 100
    template_name = "accessory.html"


class BrassView(ListView):
    model = Item
    paginate_by = 100
    template_name = "brass.html"


class StringsView(ListView):
    model = Item
    paginate_by = 100
    template_name = "strings.html"


class WindsView(ListView):
    model = Item
    paginate_by = 100
    template_name = "winds.html"
